/**
 * BookingsStack — Stack navigator for the "My Bookings" tab.
 * MyBookings → BookingDetail → ServiceExecution → sub-screens
 */
...
export const BookingsStack: React.FC = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="Dashboard" component={MyBookingsScreen} options={{ headerShown: false }} />
